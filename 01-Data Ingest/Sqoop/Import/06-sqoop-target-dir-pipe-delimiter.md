...
--password cloudera \
--table products \
--target-dir /user/cloudera/sqoop/test-target-dir-pipe-delimiter \
--fields-terminated-by '|'
```

## Step 2
```Shell
[cloudera@quickstart ~]$ hdfs dfs -ls /user/cloudera/sqoop/test-target-dir-pipe-delimiter
Found 5 items
-rw-r--r--   1 cloudera cloudera          0 2017-11-04 18:40 /user/cloudera/sqoop/test-target-dir-pipe-delimiter/_SUCCESS
-rw-r--r--   1 cloudera cloudera      41419 2017-11-04 18:40 /user/cloudera/sqoop/test-target-dir-pipe-delimiter/part-m-00000
-rw-r--r--   1 cloudera cloudera      43660 2017-11-04 18:40 /user/cloudera/sqoop/test-target-dir-pipe-delimiter/part-m-00001
-rw-r--r--   1 cloudera cloudera      42195 2017-11-04 18:40 /user/cloudera/sqoop/test-target-dir-pipe-delimiter/part-m-00002
-rw-r--r--   1 cloudera cloudera      46719 2017-11-04 18:40 /user/cloudera/sqoop/test-target-dir-pipe-delimiter/part-m-00003
```

## Step 3
```Shell
[cloudera@quickstart ~]$ hdfs dfs -tail /user/cloudera/sqoop/test-target-dir-pipe-delimiter/part-m-00000
